...
\newcommand{\std}[1]{\href{http://www.dlang.org/phobos/std_#1.html}{std.#1}\index{Phobos}\index{std!#1}}

\newcommand{\stdanchor}[2]{\href{http://www.dlang.org/phobos/std_#1.html\##2}{\DD{std.#1.#2}}\index{Phobos}\index{std!#1!#2}}
