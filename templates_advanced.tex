...
\index{templates constraints limitations}
\begin{dcode}
...
\index{class templates!and type tuples}
\index{type tuples!and class templates}
\begin{dcode}
interface I { ... }
interface J { ... }
interface K { ... }
...
By the way, code to do that, also called \DD{NoDuplicates}, is already in Phobos. It can be found in \std{typetuple}. I found coding it again a good exercise in type tuple manipulation\index{type tuple!manipulation}.
...
\unfinished{In this section, you'll see: Double-decker templates, Curried templates and how to separate two type tuples.}
