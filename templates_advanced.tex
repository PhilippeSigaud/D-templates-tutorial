...
Mainly, when a new type is defined in relation with another, already existing, type, there can be four different relationships shown in figure \ref{fig:typedef}:
