...
\aparte{Ivory Tower Wankery!}{I mean, when would sorting types be useful? It can, read on\ldots}
...
Now I may have convinced you to try and sort types, here is one way to do it. Using \DD{staticReduce}, the standard situation is the following:
