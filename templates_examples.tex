...
\susubsection{Interleaving Types}\label{interleavingtypes}
 ...
 * T0, U0, T1, U1, ...
 * If one of the inputs is shorter than the other, the longer part is put at the end
 * of the interleaving.
 */
template Interleave(First...)
{
	...
	static if (First.length == 0)
	    ...
	    alias TypeTuple!( First[0], Second[0]
	                    , Interleave!(First[1..$]).With!(Second[1..$])) With;
    }
}
